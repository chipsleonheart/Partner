...
public class MobilAdapter extends RecyclerView.Adapter<MobilAdapter.MyViewHolder> {
    ...
    public MobilAdapter(Context mContext, List<Mobil> mobilList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.title.setText(mobil.getJenis());
        holder.count.setText("Rp " + mobil.getHarga());

        // loading album cover using Glide library
        Glide.with(mContext).load(1).into(holder.thumbnail);
